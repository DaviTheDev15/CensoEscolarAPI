...
with open("schemas.sql", "r", encoding="utf-8") as sql_file:
    ...
    print(sql_script)  # debug: ver se está completo
    cursor.executescript(sql_script)

# 3. Inserir UFs
with open("UFsNordeste.json", "r", encoding="utf-8") as f:
    ufs = json.load(f)
for uf in ufs:
    cursor.execute(
...
with open("MesorregioesNordeste.json", "r", encoding="utf-8") as f:
...
with open("MicrorregiaoNordeste.json", "r", encoding="utf-8") as f:
...
with open("MunicipiosNordeste.json", "r", encoding="utf-8") as f:
